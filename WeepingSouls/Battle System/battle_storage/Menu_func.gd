...
var idx_ := 0
var activate_sound_:AudioStream
var select_sound_:AudioStream
var cancel_sound_:AudioStream
var input_ := false

func add_text_Menu(text:String) -> void:
	var menu_item := preload("res://Battle System/battle_storage/Button_Battle.tscn").instance()
	menu_item.capitalize = true
	menu_item.text = text
	add_Menu_Instance(menu_item)

func add_Menu_Instance(menu_item) -> void:
	find_node("container").add_child(menu_item)
...
#func _ready() -> void:
#	activate_sound_ = AudioStream.new()
#	activate_sound_.stream = preload("res://Battle System/battle_storage/Game_Music/activate.wav .res")
#	add_child(activate_sound_)
#
#	select_sound_ = AudioStream.new()
#	select_sound_.stream = preload("res://Battle System/battle_storage/Game_Music/select_sound.tres")
#	add_child(select_sound_)
#
#	cancel_sound_ = AudioStream.new()
#	cancel_sound_.stream = preload("res://Battle System/battle_storage/Game_Music/cancel_sound.tres")
